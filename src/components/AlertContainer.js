...
const getIcon = (type) => {
  const iconClass = getIconStyles(type);
...
const Alert = ({ id, message, type }) => {
  ...
  return (
    <div className={`flex p-4 mb-4 border-l-4 rounded-md ${alertStyles}`} role="alert">
      ...
      <button
        type="button"
        className="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex h-8 w-8 hover:bg-gray-200 focus:outline-none"
